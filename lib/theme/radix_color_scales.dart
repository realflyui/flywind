...
///
/// This file contains the pre-built Radix color scales used for template matching.
/// Each scale has 12 steps (1-12) in both light and dark modes.
///
/// Format: Map<scaleName, List<hexString>> where each list has 12 hex colors
library;
