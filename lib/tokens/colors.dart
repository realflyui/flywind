...
class FlyColors {
  ...
  /// Default color palette with Tailwind CSS v4 colors
  static const FlyColors defaultColors = FlyColors(
    // Special colors
    inherit: Color(0x00000000), // Special value for inherit
    current: Color(0x00000000), // Special value for currentColor
