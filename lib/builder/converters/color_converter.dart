...
class ColorConverter {
  ...
  static String oklchToFlutterColor(String oklchString) {
    ...
    double l =
        double.parse(match.group(1)!) / 100.0; // Convert percentage to decimal
  ...
  static List<int> _oklchToRgb(double l, double c, double h) {
    ...
    double r =
        4.076741661347994 * lms_l -
        3.307711590408193 * lms_m +
        0.230969928059508 * lms_s;
    double g =
        -1.2684380040921763 * lms_l +
        2.609757401360705 * lms_m -
        0.341319397268529 * lms_s;
    double b_val =
        -0.004196086541837188 * lms_l -
        0.7034186144594493 * lms_m +
        1.707614700001242 * lms_s;
