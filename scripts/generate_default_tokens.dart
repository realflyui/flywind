...
class TokenGenerator {
  ...
  static String _generateClass({
    ...
    buffer.writeln('// This file was generated by generate.dart');
    buffer.writeln('// To regenerate, run: dart generate/generate.dart');
    buffer.writeln('//');
    buffer.writeln();
...
Future<void> main(List<String> args) async {
  ...
  if (args.isNotEmpty) {
    if (args[0] == '--help' || args[0] == '-h') {
      print('Usage: dart generate/generate.dart [--url <custom-theme-url>]');
      print('');
      ...
      print('');
      print('Examples:');
      print('  dart generate/generate.dart');
      print('  dart generate/generate.dart --url https://raw.githubusercontent.com/tailwindlabs/tailwindcss/main/packages/tailwindcss/theme.css');
      print('');
